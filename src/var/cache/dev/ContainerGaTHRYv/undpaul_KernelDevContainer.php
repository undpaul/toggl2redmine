 ...
 */
class undpaul_KernelDevContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'undpaul\\toggl2redmine\\Command\\TimeEntrySync' => 'getTimeEntrySyncService',
        ];
        $this->aliases = [
            'undpaul\\Kernel' => 'kernel',
        ];
    }
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['undpaul\\Kernel', 'undpaul\\toggl2redmine\\Command\\TimeEntrySync']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'undpaul_KernelDevContainer',
